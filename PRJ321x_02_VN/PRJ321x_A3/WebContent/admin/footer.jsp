		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<form method="post" action='<c:url value="/logout" />'>
					<button class="btn btn-primary" href='<c:url value="/login.jsp" />'>Logout</button>
				</form>
			</div>
		</div>
	</div>
...
<script
	src='<c:url value="/admin/vendor/bootstrap/js/bootstrap.bundle.min.js"/>'></script>

<!-- Core plugin JavaScript-->
<script
	src='<c:url value="/admin/vendor/jquery-easing/jquery.easing.min.js"/>'></script>
